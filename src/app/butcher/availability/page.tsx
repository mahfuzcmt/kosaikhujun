...
export default function ButcherAvailabilityPage() {
  ...
  const getStatusLabel = (status: string) => {
    switch (status) {
      ...
      case 'BOOKED': return 'বুকড';
      case 'UNAVAILABLE': return 'অনুপলব্ধ';
  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-20">
      <div className="bg-primary text-white py-4 px-4 flex items-center gap-4 sticky top-0 z-10">
        ...
        <h1 className="text-xl font-bold">ঈদের উপলব্ধতা</h1>
      </div>

      <div className="p-4 space-y-4">
        <p className="text-gray-600 text-center mb-2">
          প্রতিটি দিনের জন্য আপনার উপলব্ধতা সেট করুন
        </p>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
          <p className="text-blue-800 text-sm">
            💡 <strong>টিপস:</strong> যদি আপনি কোনো দিনের জন্য উপলব্ধতা সেট না করেন,
            তাহলে গ্রাহকরা ধরে নেবে আপনি সেই দিন উপলব্ধ আছেন।
          </p>
        </div>
      </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around py-3">
        ...
        <NavItem icon="📅" label="উপলব্ধতা" active />

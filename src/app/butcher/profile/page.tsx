...
import { api, locationApi, uploadApi, District, Thana, ButcherDto } from '@/lib/api';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await api.patch('/butchers/me', {
        ...
        photoUrl,
        cowPrice: cowPrice ? parseInt(cowPrice) : null,
        cowPriceType,
        goatPrice: goatPrice ? parseInt(goatPrice) : null,
        goatPriceType,
  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-20">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around py-3">
        ...
        <NavItem icon="📅" label="উপলব্ধতা" onClick={() => router.push('/butcher/availability')} />
